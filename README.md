...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-11 20:11`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bc9d1f28-7593-4d9b-a681-a9f655259f77.git
$ cd bc9d1f28-7593-4d9b-a681-a9f655259f77
```
